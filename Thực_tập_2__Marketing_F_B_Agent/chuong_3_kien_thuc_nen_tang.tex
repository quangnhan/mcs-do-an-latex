\chapter{Kiến thức nền tảng và công nghệ sử
dụng}\label{kiux1ebfn-thux1ee9c-nux1ec1n-tux1ea3ng-vuxe0-cuxf4ng-nghux1ec7-sux1eed-dux1ee5ng}

\section{Nghiên cứu NLP}\label{nlp}

\subsection{Bag of word}\label{bag-of-word}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/bag_of_words.png}
    \caption{Bag of words. Nguồn: ``Bag of Words in NLP'', Medium. Trích từ: \url{https://ayselaydin.medium.com/4-bag-of-words-model-in-nlp-434cb38cdd1b}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/tf-idf.png}
    \caption{TF-IDF. Nguồn: ``Text Vectorization and Word Embedding | Guide to Master NLP (Part 5)'', Analytics Vidhya. Trích từ: \url{https://www.analyticsvidhya.com/blog/2021/06/part-5-step-by-step-guide-to-master-nlp-text-vectorization-approaches/}}
    \label{fig:tf-idf}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/word-embedding.png}
    \caption{Word embeddings. Nguồn: ``Word Embedding: Basics'', Medium. Trích từ: \url{https://medium.com/@hari4om/word-embedding-d816f643140}}
...
\begin{figure}[H]
    ...
    \caption{RNN. Nguồn: ``What is Recurrent Neural Networks (RNN)?'', Analytics Vidhya. Trích từ: \url{https://www.analyticsvidhya.com/blog/2022/03/a-brief-overview-of-recurrent-neural-networks-rnn/}}
    \label{fig:rnn}
\end{figure}

\subsection{Sequence-to-Sequence}\label{sequence-to-sequence}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/seq-to-seq.png}
    \caption{Seq2seq. Nguồn: ``Sequence-to-Sequence Learning for Machine Translation'', Dive Into Deep Learning. Trích từ: \url{https://d2l.ai/chapter_recurrent-modern/seq2seq.html}}
    \label{fig:seq2seq}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/rnn-attention.png}
    \caption{Attention Mechanism. Nguồn: ``The Attention Mechanism Before Transformers'', The AIedge. Trích từ: \url{https://newsletter.theaiedge.io/p/the-attention-mechanism-before-transformers}}
    \label{fig:attention-mechanism}
\end{figure}

\section{Nghiên cứu LLM}\label{nghiuxean-cux1ee9u-llm}

\subsection{Nghiên cứu cách máy tính hiểu ngôn ngữ tự
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/nlp.png}
    \caption{Chuyển một câu thành các token nhỏ hơn. Nguồn: ``Tokenization --- A complete guide'', Medium. Trích từ: \url{https://medium.com/@utkarsh.kant/tokenization-a-complete-guide-3f2dd56c0682}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/vector-embedding.png}
    \caption{Chuyển một câu thành một vector. Nguồn: ``A Complete Guide to Embedding For NLP \& Generative AI/LLM'', Toward AI. Trích từ: \url{https://pub.towardsai.net/a-complete-guide-to-embedding-for-nlp-generative-ai-llm-4a24301aba97}}
    \label{fig:sentence-to-vector}
\end{figure}

\subsection{Nghiên cứu quy trình huấn luyện mô hình ngôn ngữ lớn
(LLM) từ
...
\subsubsection{Chuẩn bị dữ liệu}\label{chuux1ea9n-bux1ecb-dux1eef-liux1ec7u}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/llm.png}
    \caption{Sử dụng dữ liệu từ internet để huấn luyện LLM. Nguồn: ``Làm thế nào để đào tạo Large Language Models'', VinBigData. Trích từ: \url{https://vinbigdata.com/cong-nghe-giong-noi/lam-the-nao-de-dao-tao-large-language-models.html}}
    \label{fig:training-llm-data}
\end{figure}

\subsubsection{Chuẩn bị hardware}\label{chuux1ea9n-bux1ecb-hardware}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/nvidia-gpu.png}
    \caption{NVIDIA GPU 4090. Nguồn: ``GeForce RTX 4090'', Nvidia. Trích từ: \url{https://www.nvidia.com/en-gb/geforce/graphics-cards/40-series/rtx-4090/}}
    \label{fig:nvidia-4090}
\end{figure}

\subsubsection{Training LLM}\label{training-llm}
...
\begin{figure}[H]
    ...
    \caption{Mô hình Transformer. Nguồn: ``Foundation Models, Transformers, BERT and GPT'', Niklas Heidloff. Trích từ: \url{https://heidloff.net/article/foundation-models-transformers-bert-and-gpt/}}
    \label{fig:transformer-model}
\end{figure}

\subsection{Nghiên cứu quy trình fine tune LLM với kiến thức
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/data-fine-tune-llm.png}
    \caption{Dữ liệu dạng hỏi/trả lời để fine tune LLM. Nguồn: ``A Dataset for LLM Question Answering with External Tools'', Yuchen Zhuang. Trích từ: \url{https://neurips.cc/virtual/2023/poster/73466}}
    \label{fig:qa-finetune-data}
\end{figure}

\subsubsection{Chuẩn bị hardware}\label{chuux1ea9n-bux1ecb-hardware-1}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{images/nvidia-gpu.png}
    \caption{NVIDIA GPU 4090. Nguồn: ``GeForce RTX 4090'', Nvidia. Trích từ: \url{https://www.nvidia.com/en-gb/geforce/graphics-cards/40-series/rtx-4090/}}
    \label{fig:nvidia-4090-finetune}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/llama.png}
    \caption{Mô hình Llama của Meta rất phổ biến khi fine tune LLM. Nguồn: ``LLaMA: Meta's Open-Source Rival to Google and OpenAI'', Ankur. Trích từ: \url{https://www.ankursnewsletter.com/p/llama-metas-open-source-rival-to}}
    \label{fig:llama-meta}
\end{figure}

\subsubsection{Fine tune LLM}\label{fine-tune-llm}
...
\begin{figure}[H]
    ...
    \caption{Sử dụng LoRA khi fine tune LLM. Nguồn: ``Low Rank Adaptation (LoRA): Efficient Fine-Tuning for Real-World AI Applications'', Pranjal Khadka. Trích từ: \url{https://pub.towardsai.net/low-rank-adaptation-lora-fedf37b92026}}
    \label{fig:lora-finetune}
\end{figure}

\section{Nghiên cứu AI Agent}\label{nghiuxean-cux1ee9u-ai-agent}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/ai-agent-architecture.png}
    \caption{Kiến trúc tổng quan của AI Agent. Nguồn: ``Agent 101 how to build your first ai agent in 30 minutes'', Anmol Baranwal. Trích từ: \url{https://www.copilotkit.ai/blog/agents-101-how-to-build-your-first-ai-agent-in-30-minutes}}
    \label{fig:ai-agent-architecture}
\end{figure}

\subsection{Nghiên cứu cách thêm kiến thức mới vào cho LLM}\label{nghiuxean-cux1ee9u-cuxe1ch-thuxeam-kiux1ebfn-thux1ee9c-mux1edbi-vuxe0o-cho-llm}
...
\begin{figure}[H]
    ...
    \caption{Lấy những dữ liệu bên ngoài đưa vào trong prompt. Nguồn: ``RAG from scratch''. Trích từ: \url{https://github.com/langchain-ai/rag-from-scratch}}
    \label{fig:rag-external-data}
\end{figure}

\subsection{Nghiên cứu cách giúp LLM tương tác với các phần mềm khác theo thời gian thực}\label{nghiuxean-cux1ee9u-cuxe1ch-giuxfap-llm-tux1b0ux1a1ng-tuxe1c-vux1edbi-cuxe1c-phux1ea7n-mux1ec1m-khuxe1c-theo-thux1eddi-gian-thux1ef1c}

\subsubsection{AI use tools}\label{ai-use-tools}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/ai-agent-use-tool.png}
    \caption{AI Agent sử dụng tool ngoài để đăng bài lên twitter. Nguồn: ``AI agentic workflows: a practical guide for n8n automation'', Yulia Dmitrievna. Trích từ: \url{https://blog.n8n.io/ai-agentic-workflows/}}
    \label{fig:ai-agent-twitter-tool}
\end{figure}

\subsection{Khảo sát các AI Agent opensource hiện có}\label{khux1ea3o-suxe1t-cuxe1c-ai-agent-opensource-hiux1ec7n-cuxf3}

\subsubsection{Langchain}\label{langchain}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/langchain.png}
    \caption{Langchain logo. Nguồn: ``Empowering LLMs with LangChain Framework'', Debaprasann Bhroi. Trích từ: \url{https://blog.gopenai.com/empowering-llms-with-langchain-framework-16c7a0785c2f}}
    \label{fig:langchain-logo}
\end{figure}

\subsubsection{Langgraph}\label{langgraph}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/langgraph.png}
    \caption{LangGraph logo. Nguồn: ``Building graphs for chatbots''. Trích từ: \url{https://campus.datacamp.com/courses/designing-agentic-systems-with-langchain/building-chatbots-with-langgraph?ex=1}}
    \label{fig:langgraph-logo}
\end{figure}

\subsubsection{AutoGen}\label{autogen}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/autogen.png}
    \caption{AutoGen logo. Nguồn: ``Microsoft's Agentic Frameworks: AutoGen and Semantic Kernel'', Friederike Niedtner. Trích từ: \url{https://devblogs.microsoft.com/autogen/microsofts-agentic-frameworks-autogen-and-semantic-kernel/}}
    \label{fig:autogen-logo}
\end{figure}

\subsubsection{Semantic Kernel}\label{semantic-kernel}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/semantic-kernel.png}
    \caption{Semantic Kernel logo. Nguồn: ``Semantic Kernel's new icon and the art of teamwork'', Veronica. Trích từ: \url{https://devblogs.microsoft.com/semantic-kernel/semantic-kernels-new-icon-and-the-art-of-teamwork/}}
    \label{fig:semantic-kernel-logo}
\end{figure}

\subsubsection{CrewAI}\label{crewai}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/crewai.png}
    \caption{Crewai logo. Nguồn: ``CrewAI Launches Multi-Agentic Platform to Deliver on the Promise of Generative AI for Enterprise'', Daniel D. Gutinerrez. Trích từ: \url{https://radicaldatascience.wordpress.com/2024/10/22/crewai-launches-multi-agentic-platform-to-deliver-on-the-promise-of-generative-ai-for-enterprise/}}
    \label{fig:crewai-logo}
\end{figure}

\subsubsection{Langflow}\label{langflow}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/langflow.png}
    \caption{Langflow logo. Nguồn: ``Langflow Reimagined: Streamlined for Even More Productivity''. Trích từ: \url{https://www.datastax.com/blog/langflow-brand-and-ui-reimagined-with-1-1-release}}
    \label{fig:langflow-logo}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/langflow-drag-drop.png}
    \caption{Drag \& drop để tạo workflow trong langflow. Nguồn: ``A Beginner's Guide to Building Agents in Langflow''. Trích từ: \url{https://www.datastax.com/blog/guide-to-building-agents-in-langflow}}
    \label{fig:langflow-drag-drop}
\end{figure}

\subsubsection{n8n}\label{n8n}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/n8n.png}
    \caption{n8n logo. Nguồn: ``Khám Phá N8n Workflow và Ứng Dụng Trong Tự Động Hóa AI 2025''. Trích từ: \url{https://kb.pavietnam.vn/n8n-workflow-ung-dung-ai-2025.html}}
    \label{fig:n8n-logo}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/n8n-drag-drop.png}
    \caption{Drag \& drop để tạo flow trong n8n. Nguồn: ``Building AI Agents with n8n: Low-Code approach to AI workflows''. Trích từ: \url{https://www.pondhouse-data.com/blog/ai-agents-with-n8n}}
    \label{fig:n8n-drag-drop}
\end{figure}

\subsubsection{RAGFlow}\label{ragflow}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/ragflow.png}
    \caption{RAGFlow logo. Nguồn: ``Meet RAGFlow: An Open-Source RAG (Retrieval-Augmented Generation) Engine Based on Deep Document Understanding''. Trích từ: \url{https://www.marktechpost.com/2024/04/06/meet-ragflow-an-open-source-rag-retrieval-augmented-generation-engine-based-on-deep-document-understanding/}}
    \label{fig:ragflow-logo}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/ragflow-drag-drop.png}
    \caption{Drag \& drop để tạo flow trong RAGflow. Nguồn: ``RAGFlow Enters Agentic Era'', Yingfeng Zhang. Trích từ: \url{https://ragflow.io/blog/ragflow-enters-agentic-era}}
    \label{fig:ragflow-drag-drop}
\end{figure}

\section{Agentic system}\label{agentic-system}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/agentic-orchestration.png}
    \caption{Agentic Orchestration. Nguồn: ``Think Big, Act Small: What Is Agentic AI and AI Distillation?'', concentrix. Trích từ: \url{https://www.concentrix.com/insights/blog/what-is-agentic-ai-and-ai-distillation/}}
    \label{fig:agentic-orchestration}
\end{figure}

\subsection{Planning Agent}\label{planning-agent}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/planning-agent.png}
    \caption{Planning agent. Nguồn: ``Plan-and-Execute Agents'', Langchain. Trích từ: \url{https://blog.langchain.com/planning-agents/}}
    \label{fig:planning-agent}
\end{figure}

\subsection{Specialist AI Agent}\label{specialist-ai-agent}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/specialist-agent.png}
    \caption{Specialist Agent. Nguồn: ``What is a SEO Specialist?'', Analytics Vidhya. Trích từ: \url{https://relevanceai.com/agent-templates-roles/seo-specialist-ai-agents}}
    \label{fig:specialist-agent}
\end{figure}