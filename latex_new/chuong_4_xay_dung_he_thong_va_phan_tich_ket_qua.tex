...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot coordinates {(Faith.,0.659) (Expan.,0.817) (Vibe,0.645) (Overall,0.707)};
      \addplot coordinates {(Faith.,0.599) (Expan.,0.662) (Vibe,0.450) (Overall,0.570)};
      \addplot coordinates {(Faith.,0.597) (Expan.,0.754) (Vibe,0.587) (Overall,0.646)};
      \addplot coordinates {(Faith.,0.347) (Expan.,0.465) (Vibe,0.245) (Overall,0.352)};
      \addplot coordinates {(Faith.,0.596) (Expan.,0.768) (Vibe,0.502) (Overall,0.622)};
      \addplot coordinates {(Faith.,0.637) (Expan.,0.777) (Vibe,0.648) (Overall,0.687)};
      \legend{GPT-5.4-mini,
              qwen3.5:2b (nền),
              qwen3.5:2b + SFT,
              qwen3.5:2b + RL,
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{So sánh ba chiều chất lượng và điểm tổng thể giữa các mô hình.
    SFT cải thiện đều đặn; GRPO (RL) sụt giảm mạnh do lệch miền dữ liệu
    huấn luyện.}
