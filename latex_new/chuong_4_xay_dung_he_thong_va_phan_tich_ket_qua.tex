...
Hai dòng mô hình chính được chọn để phủ phổ kích thước tham số:
\textbf{Qwen} (Alibaba Cloud, dòng 3.5 và 3.6) và \textbf{Gemma}
(Google, thế hệ 4) từ mô hình biên (edge) tới tầm trung-lớn. Mục tiêu
là xác định liệu mô hình mã nguồn mở có thể thay thế GPT-4o trong
pipeline sinh nội dung không, và kích thước tham số ảnh hưởng thế nào
