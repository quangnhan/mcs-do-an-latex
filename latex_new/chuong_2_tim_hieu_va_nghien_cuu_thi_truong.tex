...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/buffer.jpg}
    \caption{Buffer. Nguồn: ``Buffer --- Social Media Scheduler \& Analytics Tool''. Trích từ: \url{https://buffer.com/}}
    \label{fig:buffer}
\end{figure}
...
khoảng trống mà hệ thống AI Agent được đề xuất trong luận văn này hướng
tới lấp đầy.
