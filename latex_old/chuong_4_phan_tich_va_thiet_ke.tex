\section{Phân tích và thiết kế hệ
thống}\label{phuxe2n-tuxedch-vuxe0-thiux1ebft-kux1ebf-hux1ec7-thux1ed1ng}

\subsection{Phân tích yêu cầu}\label{phuxe2n-tuxedch-yuxeau-cux1ea7u}

\subsubsection{Yêu cầu chức
năng}\label{yuxeau-cux1ea7u-chux1ee9c-nux103ng}

\paragraph{Quản lý dữ liệu đầu
...
\paragraph{Trích xuất và xử lý tri
...
\paragraph{Xây dựng và quản lý Cơ sở Tri thức (Knowledge
...
\paragraph{Truy xuất thông tin bằng ngôn ngữ tự nhiên
...
\paragraph{Chức năng AI Agent hỗ trợ người dùng (Marketing Automation
...
\paragraph{Cảnh báo và nhắc nhở thông tin quan
...
\paragraph{Quản lý người dùng và phân
...
\paragraph{Ghi nhận và lưu trữ lịch sử sử
...
\subsubsection{Yêu cầu phi chức
năng}\label{yuxeau-cux1ea7u-phi-chux1ee9c-nux103ng}

\paragraph{Hiệu năng hệ
...
\paragraph{Độ chính xác và độ tin
...
\paragraph{Tính mở rộng}\label{tuxednh-mux1edf-rux1ed9ng}
...
\paragraph{Tính thân thiện với người
...
\subsubsection{Yêu cầu giao diện}\label{yuxeau-cux1ea7u-giao-diux1ec7n}
...
\paragraph{Giao diện tổng thể}\label{giao-diux1ec7n-tux1ed5ng-thux1ec3}
...
\paragraph{Giao diện chat AI Agent}\label{giao-diux1ec7n-chat-ai-agent}
...
\paragraph{Giao diện quản lý tài liệu và tri
...
\paragraph{Giao diện quản lý Knowledge
...
\paragraph{Giao diện quản lý tài
...
\paragraph{Yêu cầu về khả năng hiển thị và trải nghiệm người
...
\paragraph{Yêu cầu về ngôn ngữ và hỗ trợ người
...
\subsubsection{Phạm vi hệ thống}\label{phux1ea1m-vi-hux1ec7-thux1ed1ng}
...
\paragraph{Phạm vi chức năng được thực
...
\paragraph{Phạm vi triển khai}\label{phux1ea1m-vi-triux1ec3n-khai}
...
\subsection{Thiết kế hệ thống bậc
cao}\label{thiux1ebft-kux1ebf-hux1ec7-thux1ed1ng-bux1eadc-cao}

\subsubsection{Kiến trúc tổng
...
\includegraphics[width=6.57813in,height=2.54951in]{media/image1.png}

\emph{\textbf{Hình 4.2.1. Kiến trúc tổng thể.}}

\subsubsection{Các thành phần chính của hệ
...
\subsubsection{Sơ đồ luồng dữ liệu tổng
quan}\label{sux1a1-ux111ux1ed3-luux1ed3ng-dux1eef-liux1ec7u-tux1ed5ng-quan}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Nạp tri thức (Knowledge Ingestion Pipeline)}
\end{enumerate}

\includegraphics[width=6.26772in,height=3.66667in]{media/image2.png}

\emph{\textbf{Hình 4.2.3. Sơ đồ dữ liệu nạp tri thức.}}
...
\item
  ...
  \def\labelenumi{\arabic{enumi}.}
  \item
    \textbf{Truy xuất và Trả lời (Retrieval \& Generation Pipeline)}
  \end{enumerate}
\end{itemize}

\includegraphics[width=6.26772in,height=4.01389in]{media/image3.png}
...
\subsection{Thiết kế cơ sở dữ liệu sơ
bộ}\label{thiux1ebft-kux1ebf-cux1a1-sux1edf-dux1eef-liux1ec7u-sux1a1-bux1ed9}

\includegraphics[width=6.50896in,height=5.04931in]{media/image4.png}

\emph{\textbf{Hình 4.3. Cơ sở dữ liệu}}
