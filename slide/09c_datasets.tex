...
\begin{frame}[t]{Dữ liệu huấn luyện SFT (500 mẫu)}
  ...
  \begin{block}{Cấu trúc mỗi mẫu}
    ...
    \hfill
    Đa dạng: đồ uống, ăn nhanh, ăn ngồi; bình dân -- trung cấp;
    AI-generated + hiệu chỉnh thủ công
  \end{block}
\end{frame}

% --- Slide 2: GRPO / Dining Review ---
\begin{frame}[t]{Dữ liệu huấn luyện GRPO --- Dining Review (500 bài)}
  \begin{columns}[T,onlytextwidth]
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      \begin{block}{\texttt{content} --- để trống}
        ...
        SFT, GRPO, GPT-5.4-mini)
      \end{block}
    \end{column}
  \end{columns}
  \vspace{0.5em}
  \begin{block}{Đặc thù tập kiểm thử}
    \scriptsize
    Thu thập từ nhà hàng thực tế tại Việt Nam ---
    từ vựng nhà hàng địa phương, đơn vị phần ăn, văn phong thương hiệu
    gần nhất với triển khai thực tế của hệ thống.
  \end{block}
\end{frame}
